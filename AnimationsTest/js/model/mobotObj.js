this.mobotObj = function() {
    ...
    this.images = []; //contains all robot images. Its filled when loadData() is called
    this.enemy;
	
    ////////////////////////////////////////////////////////////////////////////METHODS       
};
mobotObj.prototype.loadData = function() {
...
mobotObj.prototype.createEnemy = function(enemyName) {
